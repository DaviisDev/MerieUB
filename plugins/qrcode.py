...
from . import check_filename, get_string, merie_bot, merie_cmd


@merie_cmd(pattern="qrcode( (.*)|$)")
async def cd(e):
    ...
    elif merie_bot.me.photo and not merie_bot.me.photo.has_video:
        cimg = (await e.client.get_profile_photos(merie_bot.uid, limit=1))[0]
