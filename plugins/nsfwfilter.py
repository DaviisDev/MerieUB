...
from . import HNDLR, async_searcher, eor, events, mdB, merie_bot, merie_cmd


@merie_cmd(pattern="addnsfw( (.*)|$)", admins_only=True)
async def addnsfw(e):
...
@merie_cmd(pattern="remnsfw", admins_only=True)
async def remnsfw(e):
    rem_nsfw(e.chat_id)
