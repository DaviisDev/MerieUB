...
from . import LOGS, async_searcher, eod, get_string, safeinstall, merie_cmd, un_plug


@merie_cmd(pattern="install", fullsudo=True)
...
@merie_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
