...
from . import HNDLR, eor, get_string, mediainfo, merie_cmd
from ._inline import something

Note = "\n\nNote: `{mention}`, `{group}`, `{count}`, `{name}`, `{fullname}`, `{username}`, `{userid}` can be used as formatting parameters.\n\n"


@merie_cmd(pattern="setwelcome", groups_only=True)
...
@merie_cmd(pattern="clearwelcome$", groups_only=True)
...
@merie_cmd(pattern="getwelcome$", groups_only=True)
...
@merie_cmd(pattern="setgoodbye", groups_only=True)
...
@merie_cmd(pattern="cleargoodbye$", groups_only=True)
...
@merie_cmd(pattern="getgoodbye$", groups_only=True)
...
@merie_cmd(pattern="thankmembers (on|off)", groups_only=True)
