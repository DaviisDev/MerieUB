...
from . import HNDLR, LOGS, asst, con, get_string, mediainfo, os, types, mdB, merie_cmd
...
async def _(e):
    ...
    await e.client.send_message(
        int(mdB.get_key("LOG_CHANNEL")), get_string("chats_6").format(e.chat_id)
    )
...
@merie_cmd(pattern="unbanall$", manager=True, admins_only=True, require="ban_users")
async def _(event):
