...
from . import inline_mention, is_url_ok, json_parser, mediainfo, merie_cmd


@merie_cmd(pattern="tr( (.*)|$)", manager=True)
async def _(event):
...
@merie_cmd(pattern="bots( (.*)|$)", groups_only=True, manager=True)
async def _(ult):
