...
@merie_cmd(pattern="kickme$", fullsudo=True)
async def leave(ult):
...
@merie_cmd(pattern="paste( (.*)|$)", manager=True, allow_all=True)
async def _(event):
    try:
...
@merie_cmd(pattern="suggest( (.*)|$)", manager=True)
