...
from . import eod, eor, get_string, mediainfo, merie_cmd
...
@merie_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@merie_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@merie_cmd(pattern="setpic$", fullsudo=True)
async def _(ult):
    if not ult.is_reply:
...
@merie_cmd(pattern="delpfp( (.*)|$)", fullsudo=True)
